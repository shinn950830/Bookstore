					...
					<?php
						...
						if($result->num_rows>0){
							...
							while($row = $result->fetch_assoc()){
								echo "<tr><td><input type=\"radio\" name=\"editSelection\" value=\"".$row['Product_ID']. "\"/></td><td>".$row['Product_ID']."</td><td>".$row['ISBN']."</td><td>".$row['Title']."</td><td>".$row['Author']."</td><td>".$row['Time_Added']."</td><td>".$row['Time_Edited']."</td>";
							}
